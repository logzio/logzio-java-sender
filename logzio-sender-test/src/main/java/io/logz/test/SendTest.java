 ...
 */
public abstract class SendTest extends BaseTest {
    ...
    public void simpleAppending() throws Exception {
        ...
        TestWrapper testSender = getTestSenderWrapper(token, type, loggerName, drainTimeout, 98,
                null, 10 * 1000,false, "",30 , port);

        Optional level1 = testSender.info( message1);
        Optional level2 = testSender.warn( message2);
    ...
    public void multipleBufferDrains() throws Exception {
        ...
        TestWrapper testWrapper = getTestSenderWrapper(token, type, loggerName, drainTimeoutSec, 98,
                null, 10 * 1000,false, "",30 , port);


        Optional level1 = testWrapper.info( message1);
        ...
        Optional level2 = testWrapper.warn(message2);
    ...
    public void longDrainTimeout() throws Exception {
        ...
        Optional level1 = testWrapper.info( message1);
        Optional level2 = testWrapper.error(message2);
    ...
    public void fsPercentDrop() throws Exception {
        ...
        TestWrapper testWrapper = getTestSenderWrapper(token, type, loggerName, drainTimeoutSec, fsPercentDrop,
                null, 10 * 1000,false, "",30 , port);
    ...
    public void serverCrash() throws Exception {
        ...
        Optional level3 = testWrapper.warn( message3);
